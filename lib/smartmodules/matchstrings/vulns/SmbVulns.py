...
vulns_match['smb'] = {
    ...
    'impacket': {
        r'Found writable share (ADMIN|C)\$': 'SMB Code Execution possible via psexec',
        r'Process cmd\.exe /c ".*?" finished with ErrorCode: 0': 'SMB Code Execution possible via psexec',
    },
    'nmap': {
